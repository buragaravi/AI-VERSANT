...
def main():
    ...
    if all_passed:
        ...
        print("OneSignal should work properly now.")
    else:
        print("❌ Some service worker files have incorrect MIME type.")
        print("Please check your server configuration (nginx.conf or .htaccess)")
        print("and ensure service worker files are served with 'application/javascript' MIME type.")
