        ...
        for student in student_list:
            try:
                ...
                try:
                    ...
                    <html>
                    <body>
                        <h2>New Writing Test Available: {test['name']}</h2>
                        <p>Hello {student['name']},</p>
                        <p>You have been assigned a new writing test: {test['name']}</p>
                ...
                if mobile_number:
                    try:
                        ...
                        sms_message = f"New writing test '{test['name']}' assigned to you. Login to take the test. - Study Edge"
